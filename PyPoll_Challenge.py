...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        if (county_vote > largest_turnout_county):
            #largest turnout county is a variable
            largest_turnout_county = county_vote
            #name for the county ass
            largest_turnout_name = county
